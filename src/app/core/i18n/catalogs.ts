...
const nl = deepMerge(en, {
  ...
  chrome: {
    nav: { plans: 'Plannen', customers: 'Klanten', entitlements: 'Rechten', invoices: 'Facturen', soutenir: 'Steunen', aria_main: 'Hoofdnavigatie', aria_mobile: 'Mobiele navigatie' },
...
const it = deepMerge(en, {
  ...
  chrome: {
    nav: { plans: 'Piani', customers: 'Clienti', entitlements: 'Diritti', invoices: 'Fatture', soutenir: 'Sostieni', aria_main: 'Navigazione principale', aria_mobile: 'Navigazione mobile' },
...
const es = deepMerge(en, {
  ...
  chrome: {
    nav: { plans: 'Planes', customers: 'Clientes', entitlements: 'Derechos', invoices: 'Facturas', soutenir: 'Apoyar', aria_main: 'Navegación principal', aria_mobile: 'Navegación móvil' },
