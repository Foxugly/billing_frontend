...
const nl = deepMerge(en, {
  ...
  chrome: {
    nav: { customers: 'Klanten', entitlements: 'Rechten', soutenir: 'Steunen', aria_main: 'Hoofdnavigatie', aria_mobile: 'Mobiele navigatie' },
...
const it = deepMerge(en, {
  ...
  chrome: {
    nav: { customers: 'Clienti', entitlements: 'Diritti', soutenir: 'Sostieni', aria_main: 'Navigazione principale', aria_mobile: 'Navigazione mobile' },
...
const es = deepMerge(en, {
  ...
  chrome: {
    nav: { customers: 'Clientes', entitlements: 'Derechos', soutenir: 'Apoyar', aria_main: 'Navegación principal', aria_mobile: 'Navegación móvil' },
